...
insert into drugs(id, "code", "name", "description", "drug_type","drug_state",  "drug_origin", "producer", "dosage", "issuing_type", score, points) values(4, '2155432161', 'Tetrakain', 'Dont take on empty stomach', 'STIMULANTS', 'POWDER', 'BIOLOGICAL ', 'BYER',  '50mg', 'ON_PRESCRIPTION', 0, 1);
insert into drugs(id, "code", "name", "description", "drug_type","drug_state",  "drug_origin", "producer", "dosage", "issuing_type", score, points) values(5, '2419674621', 'Xanax', 'Dont take on empty stomach', 'ANTIBIOTICS', 'SYRUP', 'BIOLOGICAL ', 'BYER',  '100mg', 'ON_PRESCRIPTION', 0, 5);
insert into drugs(id, "code", "name", "description", "drug_type","drug_state",  "drug_origin", "producer", "dosage", "issuing_type", score, points) values(6, '2520160013', 'Bensedin', 'Possible allergy', 'MOOD_STABILIZERS', 'SYRUP', 'HERBAL', 'BYER',  '50mg', 'ON_PRESCRIPTION', 40, 5);
insert into drugs(id, "code", "name", "description", "drug_type","drug_state",  "drug_origin", "producer", "dosage", "issuing_type", score, points) values(7, '6144614336', 'Andol', 'Possible allergy', 'MOOD_STABILIZERS', 'SYRUP', 'HERBAL ', 'Alkaloid AD-Skopje',  '250mg', 'ON_PRESCRIPTION', 0, 4);
...
insert into patients(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, is_activated, phone_no) values (1, 'Jovan', 'Ivosevic', 'ivos.jovan@protonmail.ch', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '21000', 'Novi Sad', 'Balzakova', '69', 0.0, 0.0, true, '0607671370'); --password:Sifra123
insert into patients(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, is_activated, phone_no) values (2, 'Mile', 'Knezevic', 'lemara98@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '21000', 'Novi Sad', 'Bulevar Oslobodjenja', '42', 0.0, 0.0, true, '0631931345'); --password:Sifra123
insert into patients(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, is_activated, phone_no) values (52, 'Marko', 'Pekez', 'marko.ppekez25@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '21000', 'Novi Sad', 'Bulevar Oslobodjenja', '42', 0.0, 0.0, true, '0631931345'); --password:Sifra123

insert into pharmacists(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, pharmacy_id, is_activated, score, is_default_password_changed) values (3, 'Ana', 'Anic', 'rzupunski@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '11000', 'Beograd', 'Bulevar', '1', 0.0, 0.0, 1, true, 4, true);--password:Sifra123
insert into pharmacists(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, pharmacy_id, is_activated, score, is_default_password_changed) values (4, 'Marina', 'Ludajic', 'madrina@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '371136', 'Kikinda', 'Generala Milutinovica', '5', 0.0, 0.0, 2, true, 3.4, true);--password:Sifra123
insert into pharmacists(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, pharmacy_id, is_activated, score, is_default_password_changed) values (5, 'Sanja', 'Dudas', 'sanjaa.d98@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '21315', 'Lug', 'Marsala Tita 48', '5', 0.0, 0.0, 1, true, 5, true);--password:Sifra123


insert into dermatologists(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, is_activated, score, is_default_password_changed) values (6, 'Marija', 'Maric', 'radovan.zupunski@uns.ac.rs', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '11000', 'Beograd', 'Jurija Gagarina', '4', 0.0, 0.0, true, 3, true);--password:Sifra123
insert into dermatologists(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, is_activated, score) values (7, 'Milan', 'Milanovic', 'milan@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '11000', 'Beograd', 'Jurija Gagarina', '4', 0.0, 0.0, true, 3.4);--password:Sifra123
insert into dermatologists(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, is_activated, score) values (12, 'Natasa', 'Natasic', 'natasa@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '11000', 'Beograd', 'Jurija Gagarina', '4', 0.0, 0.0, true, 3.4);--password:Sifra123
insert into dermatologists(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, is_activated, score) values (13, 'Luka', 'Lukic', 'luka@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '11000', 'Beograd', 'Jurija Gagarina', '4', 0.0, 0.0, true, 3.4);--password:Sifra123


insert into pharmacyadmins(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, pharmacy_id, is_activated) values (8, 'Mika', 'Mikic', 'jankovicpharmacy@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', 'Beograd', '11000', 'Bulevar', '1', 0.0, 0.0, 1, true); --password: Sifra123
insert into pharmacyadmins(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, pharmacy_id, is_activated) values (11, 'Zoran', 'Zoranovic', 'zoran@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', 'Beograd', '11000', 'Bulevar', '1', 0.0, 0.0, 2, true); --password: Sifra123

insert into suppliers(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, firm, is_activated) values (9, 'Zoki', 'Zokic', 'zoki@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '11000', 'Beograd', 'Carlija Caplina', '12', 0.0, 0.0, 'Dobavljac Zoki', false);--password:Sifra123
insert into suppliers(id, "name", surname, email, "password", city, postcode, street, street_no, latitude, longitude, firm, is_activated) values (10, 'Jovan', 'Jovanovic', 'jovan@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu', '21000', 'Novi Sad', 'Bulevar Oslobodjenja', '14a', 0.0, 0.0, 'Jova trans', true);--password:Sifra123
...
insert into userss(id, "email", "password") values (1, 'ivos.jovan@protonmail.ch', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu');
insert into userss(id, "email", "password") values (2, 'lemara98@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu');
insert into userss(id, "email", "password") values (3, 'rzupunski@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu');
insert into userss(id, "email", "password") values (4, 'madrina@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu');
insert into userss(id, "email", "password") values (5, 'sanjaa.d98@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu');
insert into userss(id, "email", "password") values (6, 'radovan.zupunski@uns.ac.rs', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu');
insert into userss(id, "email", "password") values (8, 'jankovicpharmacy@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu');
insert into userss(id, "email", "password") values (11, 'zoran@gmail.com', '$2a$10$7JMB1YaL6mEljudbAhnt/.x7fk9hU6FPFaEJ8Fl4WrqqSXshpXPAu');
