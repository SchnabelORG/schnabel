...
insert into recipe_items values(1, 2, 111, 1);
insert into recipe_items values(2, 5, 555, 1);

insert into drugs_reservations values(1, '2021-05-20', 2, '2021-05-04', true, 111, 1);
insert into drugs_reservations values(2, '2020-05-20', 2, '2020-05-04', false, 111, 1);
insert into drugs_reservations values(3, '2021-07-20', 2, '2021-05-04', false, 111, 1);


insert into availability_request values(1, 10, 111, 5, 1);
insert into availability_request values(2, 5, 222, 5, 1);
insert into availability_request values(3, 7, 333, 5, 1);
