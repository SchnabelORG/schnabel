...
public interface IDrugService extends IJpaService<Drug, Long> {
    ...
    boolean registerDrug(String code, String name, String description, DrugState drugState, DrugOrigin drugOrigin, DrugType drugType, String producer, String dosage, String ingredients, IssuingType issuingType);
}
